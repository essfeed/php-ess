<?php
	...
	$essFeed->setRights( 'Copyright (c) ' . date( 'Y' ) . ', ESS Generator' );	// Specified the Copyright of this Feed.
		...
		// =========
		// === /!\ 		Useful function to get the number of occurence between two dates in days, weeks, months or years.
		// =========	This function can be used to define the Date "limit" of an event according to the "unit" defined.
		// =========	Because sometime the end of an event is define by a Date and not by number of occurences.
		// =========	
